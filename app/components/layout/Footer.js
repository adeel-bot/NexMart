    ...
    <div className='bg-[#E2F4FF] '>
            ...
            rounded-2xl bg-white p-12'>
              ...
              <div className='bg-[#EDA415] flex gap-4 text-white rounded-2xl px-6 py-3 focus:border-none'>
                <input className='px-4 text-sm py-2 rounded-xl placeholder:text-sm focus:ring-0 focus:outline-[1px] focus:outline-white ' type="email" name="email"  id="email" placeholder='Email Address'/>
                <Image className='cursor-pointer' src="/send.svg" height={22} width={22}  alt="send-icon" />
                </div>
              <div className='flex gap-3 items-center'>
                <div >
                <Image  src="/headset.svg" height={34} width={34}  alt="headset-icon" />
                </div>
